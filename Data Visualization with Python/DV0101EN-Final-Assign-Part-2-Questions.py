...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'center', 'color': 'Black', 'font-size': 36}),#May include style for title
    html.P("Select a 'statistical report type' and 'Year' to create graphs", style={'textAlign': 'center', 'color': 'grey', 'font-size': 18}),
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(id='dropdown-statistics',
                    ...
                    style={'width': '100%', 'textAlign': 'center', 'font-size': 20}
        )
    ]),
    html.Div([
    ...
    # Modified: Use CSS Grid for a 2x2 layout
    html.Div(id='output-container', style={'display': 'grid', 'grid-template-columns': '1fr 1fr', 'gap': '10px', 'padding': '10px'})
], style={'maxWidth': '1800px', 'margin': 'auto', 'padding': '10px'}) # <--- ADDED THIS STYLE HERE
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        # Modified: Return a flat list of the four charts
        return [
